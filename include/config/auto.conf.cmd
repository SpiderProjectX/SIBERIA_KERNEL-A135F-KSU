...
ifneq "$(CC)" "./toolchain/clang-12/bin/clang"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=./toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/home/assanelupintk/Downloads/MizKernel-GalaxyA135F-stable-ksu/toolchain/aarch64-linux-android-4.9 -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
